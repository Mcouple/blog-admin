...
export const constantRoutes = [{
...

    {
        ...
        children: [{
            ...
            meta: { title: '控制台', icon: 'el-icon-odometer', auth: true }
        }]
    },
    {
        path: '/banner',
    ...
    },
    {
        ...
        children: [{
                ...
                name: 'BlogList',
                component: () =>
                    import ('@/views/blog/blogList/index'),
            ...
            },
            {
                ...
                name: 'Addblog',
                component: () =>
                    import ('@/views/blog/addblog/index'),
    ...
    },
    {
        ...
        children: [{
                path: 'projectList',
                component: () =>
                    import ('@/views/project/projectList/index'),
                name: 'ProjectList',
                meta: { title: '项目列表', icon: "el-icon-files", auth: true },
            },
            {
                path: 'addProject',
                component: () =>
                    import ('@/views/project/addProject/index'),
                name: 'AddProject',
                meta: { title: '添加项目', icon: 'el-icon-paperclip', auth: true }
            }
        ]
    },

    {
        ...
        children: [{
            ...
            meta: { title: '评论管理', icon: 'el-icon-postcard', auth: true }
        }]
    },
    ...
    },
    {
        path: 'external-link',
        children: [{
            path: 'https://github.com/Mcouple?tab=repositories',
            meta: {
                title: 'Link',
